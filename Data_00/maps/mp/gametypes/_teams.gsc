...
initScoreBoard()
{
	setDvar("g_TeamName_Allies", "Primis");
	setDvar("g_TeamIcon_Allies", "cardicon_umbracatervae");
	setDvar("g_TeamIcon_MyAllies", "cardicon_umbracatervae");
	setDvar("g_TeamIcon_EnemyAllies", "cardicon_umbracatervae");
	...
	setDvar("g_TeamIcon_MyAxis", "");
	setDvar("g_TeamIcon_EnemyAxis", "");
