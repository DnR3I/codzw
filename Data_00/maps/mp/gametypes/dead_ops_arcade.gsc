...
main()
{
	...
	{
		setDvar("g_gametype", "dead_ops_arcade");
		setDvar("ui_gametype", "dead_ops_arcade");
		setDvar("party_gametype ", "Dead Ops Arcade");
		map(getDvar("mapname"));
	}
...
onStartGameType()
{
	...
	level thread maps\zm\d_ops_arcade\loading::Init();
}
