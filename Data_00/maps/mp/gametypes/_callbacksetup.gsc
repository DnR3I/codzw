...
CodeCallback_PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, timeOffset)
{
	...
	if(sWeapon == "ac130_40mm_mp" || sWeapon == "ac130_105mm_mp" || sWeapon == "ac130_25mm_mp")
	{
		if(self == eAttacker)
			iDamage = 0;
	}
...
doGib()
{
	...
	if(level.wave != 4 || level.wave != 2)
	{
		playFx( level._effect["blood1"], self.origin + (randomInt(25),randomInt(25),40));
		playFx( level._effect["blood2"], self.origin + (randomInt(25),randomInt(25),50));
		playFx( level._effect["blood3"], self.origin + (randomInt(25),randomInt(25),60));
		playFx( level._effect["blood2"], self.origin + (randomInt(25),randomInt(25),70));
		wait 1;
	}
}
...
{
	level endon("game_ended");
	// we want big blood spray
	playFx( level._effect["blood" + randomInt(2) + ""], self.origin + (randomInt(100),randomInt(100),randomInt(100)));
	playFx( level._effect["blood" + randomInt(2) + ""], self.origin + (randomInt(100),randomInt(100),randomInt(100)));
	playFx( level._effect["blood" + randomInt(2) + ""], self.origin + (randomInt(100),randomInt(100),randomInt(100)));
	playFx( level._effect["blood" + randomInt(2) + ""], self.origin + (randomInt(100),randomInt(100),randomInt(100)));
	playFx( level._effect["blood" + randomInt(2) + ""], self.origin + (randomInt(100),randomInt(100),randomInt(100)));
